...
integer(i4) :: pnum
real(r8) :: assim, resp
real(r8) :: assimc13, d13cassim
real(r8) :: d13cfemis, firec13, firetotc
real(r8) :: d13cresptot, resptotc13
real(r8) :: kiecps, kiecpsk1, &
            kiecpsk2, kiecpsk3, &
            kiecpsk4, kiecpsk5
...
!      outsave(i,refsave) = outsave(i,refsave) + dble(sibg%gprogt%pco2m)*1.0D6/pressure
   ...
   case (870)  !kiecps
      ...
      do l=1,sibg%g_nlu
         kiecps = kiecps + &
                (sibg%l(l)%fract%kiecps * sibg%l(l)%larea)
      enddo
      outsave(i,refsave) = outsave(i,refsave) + kiecps   

   case (871)  !kiecps_k1
      kiecpsk1 = dzero
      do l=1,sibg%g_nlu
         kiecpsk1 = kiecpsk1 + &
                (sibg%l(l)%fract%kiecps_k1 * sibg%l(l)%larea)
      enddo
      outsave(i,refsave) = outsave(i,refsave) + kiecpsk1

   case (872)  !kiecps_k2
      kiecpsk2 = dzero
      do l=1,sibg%g_nlu
         kiecpsk2 = kiecpsk2 + &
                (sibg%l(l)%fract%kiecps_k2 * sibg%l(l)%larea)
      enddo
      outsave(i,refsave) = outsave(i,refsave) + kiecpsk2

   case (873)  !kiecps_k3
      kiecpsk3 = dzero
      do l=1,sibg%g_nlu
         kiecpsk3 = kiecpsk3 + &
                (sibg%l(l)%fract%kiecps_k3 * sibg%l(l)%larea)
      enddo
      outsave(i,refsave) = outsave(i,refsave) + kiecpsk3

   case (874)  !kiecps_k4
      kiecpsk4 = dzero
      do l=1,sibg%g_nlu
         kiecpsk4 = kiecpsk4 + &
                (sibg%l(l)%fract%kiecps_k4 * sibg%l(l)%larea)
      enddo
      outsave(i,refsave) = outsave(i,refsave) + kiecpsk4

   case (875)  !kiecps_k5
      kiecpsk5 = dzero
      do l=1,sibg%g_nlu
         kiecpsk5 = kiecpsk5 + &
                (sibg%l(l)%fract%kiecps_k5 * sibg%l(l)%larea)
      enddo
      outsave(i,refsave) = outsave(i,refsave) + kiecpsk5

   case (876)  !d13cassim
      d13cassim = dzero
      do l=1,sibg%g_nlu
         d13cassim = d13cassim + &
                (sibg%l(l)%fract%d13cassim * sibg%l(l)%larea)
      enddo
      outsave(i,refsave) = outsave(i,refsave) + d13cassim

   case (877)  !d13cresptot
      d13cresptot = dzero
      do l=1,sibg%g_nlu
         d13cresptot = d13cresptot + &
                    (sibg%l(l)%fract%d13cresp_totc13*sibg%l(l)%larea)
      enddo
      outsave(i,refsave) = outsave(i,refsave) + d13cresptot
   ...
   case (882)  !d13cemis_fire
      ...
      do l=1,sibg%g_nlu
        d13cfemis = d13cfemis +  &
          (sibg%l(l)%fract%d13cemisfire_pool*sibg%l(l)%larea)
      enddo
      outsave(i,refsave) = outsave(i,refsave) + d13cfemis
