...
if (sibg%gprogt%firec .gt. dzero) then
   ...
   do l=ido,1,-1
      ...
      !tempemisc13 = sibg%l(myl)%poollt%rcpoolfire*tempemis
      tempemisc13 = sibg%l(myl)%fract%rcassimfac * tempemis
      curemisc13 = tempemisc13
      !rcpooltest = rcpooltestf
      ...
      flosspft(myl,lpc13) = sibg%l(myl)%fract%rcassimfac*myemis
      sibg%l(myl)%poollt%loss_fire_lay(lpc13,1) = &
           sibg%l(myl)%fract%rcassimfac*myemis * dtisib
      sibg%l(myl)%poollt%poolpft_dloss(lpc13,1) = &
           sibg%l(myl)%poollt%poolpft_dloss(lpc13,1) &
           + sibg%l(myl)%fract%rcassimfac*myemis
      curemisc13 = curemisc13 - sibg%l(myl)%fract%rcassimfac*myemis
      ...
      flosspft(myl,wpc13) = sibg%l(myl)%fract%rcassimfac*myemis
      ...
      flosslu(myl,metlpc13) = sibg%l(myl)%fract%rcassimfac*myemis
      ...
      flosslu(myl,strlpc13) = sibg%l(myl)%fract%rcassimfac*myemis
      ...
      flosslu(myl,cdbpc13) = sibg%l(myl)%fract%rcassimfac*myemis
      ...
      IF (curemis .gt. dnzero) THEN
         ...
         flosspft(myl,ppc13) = sibg%l(myl)%fract%rcassimfac*myemis
      ...
      IF (curemis .gt. dnzero) THEN
          ...
          flosspft(myl,frpc13) = sibg%l(myl)%fract%rcassimfac*myemis
          curemis = curemis - myemis
          curemisc13 = curemisc13 - sibg%l(myl)%fract%rcassimfac*myemis
       ENDIF
       ...
       IF (curemis .gt. dnzero) THEN        
          ...
          flosspft(myl,crpc13) = sibg%l(myl)%fract%rcassimfac*myemis
          curemis = curemis - myemis
          curemisc13 = curemisc13 - sibg%l(myl)%fract%rcassimfac*myemis
       ENDIF
       ...
       IF (curemis .gt. dnzero) THEN
          ...
          flosslu(myl,slitpc13) = sibg%l(myl)%fract%rcassimfac*myemis
          curemis = curemis - myemis
          curemisc13 = curemisc13 - sibg%l(myl)%fract%rcassimfac*myemis
      ENDIF
      ...
      IF (curemis .gt. dnzero) THEN
          ...
          flosslu(myl,slowpc13) = sibg%l(myl)%fract%rcassimfac*myemis
          curemis = curemis - myemis
          curemisc13 = curemisc13 - sibg%l(myl)%fract%rcassimfac*myemis
      ENDIF
      ...
      IF (curemis .gt. dnzero) THEN
         ...
         DO s=1,nsoil 
          ...
          flosslu(myl,armpc13) = sibg%l(myl)%fract%rcassimfac*myemis
          curemis = curemis - myemis
          curemisc13 = curemisc13 - sibg%l(myl)%fract%rcassimfac*myemis
      ENDIF
