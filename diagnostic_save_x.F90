...
!      outsave(i,refsave) = outsave(i,refsave) + dble(sibg%gprogt%pco2m)*1.0D6/pressure
   ...
   case (880)  !co2cas_g
      co2casg = dzero
      do l=1,sibg%g_nlu
         co2casg = co2casg + sibg%l(l)%co2t%co2cas * mol_to_umol &
                 * sibg%l(l)%larea
      enddo
      outsave(i,refsave) = outsave(i,refsave) + co2casg

   case (881)  !c13ca_g
      c13cag = dzero
      do l=1,sibg%g_nlu
         c13cag = c13cag + sibg%l(l)%fract%c13ca * mol_to_umol &
                 * sibg%l(l)%larea
      enddo
      outsave(i,refsave) = outsave(i,refsave) + c13cag
